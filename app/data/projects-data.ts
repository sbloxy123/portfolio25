...
export const projects: ProjectType[] = [
  {
    ...
    websiteLink: 'https://www.perlini.co.uk',
    ...
    captionedImages: [
      ...
      {
        image: 'rosco/rosco-image-slider',
  ...
  },
  {
    ...
    image: 'meal-prep-app',
    features: [
      'Full-stack side project built to explore backend development',
      'Built with Express.js, PostgreSQL, and EJS templating',
      'Fully functioning meal planning and shopping list app',
      'AI-assisted ingredient and aisle organisation via Claude API integration',
    ],
    tech: [
      'Express.js',
      'Vanilla CSS',
    ...
    websiteLink: 'https://meal-prep-app-production-7120.up.railway.app/recipes',
    innerPageLink: 'meal-prep-app',
    githubLink: 'https://github.com/sbloxy123/meal-prep-app',
    projectType: 'Self/Side Project',
    description: [
      'A personal full-stack web app built to simplify weekly meal planning and grocery shopping. The app allows users to build a library of familiar meals, select them for the week, and generate a consolidated shopping list — with items organised by supermarket aisle for efficient in-store navigation. Developed primarily as an opportunity to explore backend development, the design was kept intentionally minimal to allow focus on functionality, serving as a hands-on MVP for learning server-side architecture, database management, and API integration.',
    ],
    fullFeatureList: [
      'Built as a practical introduction to full-stack and backend development, covering server-side logic, routing, and database management',
      'Intentionally minimal UI design to prioritise rapid development and functional testing as a personal MVP',
      'Full CRUD operations implemented with vanilla JavaScript and PostgreSQL, using fetch-based database interactions',
      'Meal planning workflow: select meals for the week, choose which ingredients need restocking, and generate a consolidated shopping list',
      'Shopping list organised by supermarket aisle for efficient in-store navigation, with support for ad-hoc items in a separate list',
      'Claude API integration to assist with ingredient categorisation and aisle organisation',
      'Styled using modern CSS practices with CSS variables, organised into a clean and maintainable file structure',
      'Hosted on Railway with source code managed on GitHub',
    ],
    captionedImages: [
      {
        image: 'meal-app/organised-list',
        ariaLabel: 'Screenshot of organised shopping list',
        caption:
          'AI generated list to sort shopping list into supermarket aisles for speedier shopping.',
      },
    ],
  },
  {
    ...
    websiteLink: 'https://www.bloxie.co.uk',
  ...
  },
  {
    ...
    image: 'stephen-perce',
    features: [
      'Multiple bespoke pages with customised CMS functionality',
      'Pixel-perfect implementation with bespoke loading animations and transitions',
      'Component-driven development for reusable sections across the build',
      'Completely editable by the client via an in-house CMS for ongoing maintainability',
    ],
    tech: ['CSS', 'ASP.NET', 'JavaScript', 'WCAG', 'Swiper.js'],
    websiteLink: 'https://www.stephenperse.com/',
    innerPageLink: 'stephen-perce',
    projectType: 'Employed (Juniper Education)',
    description: [
      "Classified as an 'Elite' product by the agency, this bespoke website was built for Stephen Perse over the course of five weeks. It features multiple custom pages with tailored CMS functionality, achieved through innovative development methods to meet the client's exacting requirements. The project received outstanding feedback from both the client and colleagues upon completion, and is fully editable via the in-house CMS to ensure long-term maintainability.",
    ],
    fullFeatureList: [
      "Recognised internally as an 'Elite' product, reflecting the high standard of the finished build",
      'Component-driven development enabling reusable sections throughout the site',
      'Pixel-perfect CSS implementation with minimal post-build fixes',
      'Bespoke loading animations and transitions for a polished, engaging user experience',
      'Multiple custom pages with tailored CMS functionality, developed using innovative methods to meet specific client requirements',
      'Multiple Swiper.js instances featuring unique user interactions, requiring a strong attention to detail to ensure end-user engagement',
      'Strong use of CSS variables for efficient styling and straightforward maintainability',
      'Completely editable by the client via the in-house CMS, ensuring content can be managed and updated with ease',
  ...
  },
  {
    ...
    projectType: 'Self/Freelance',
    description: [
      'This website is an integral part of my portfolio so I wanted to add it to the list. Built to showcase my skills in modern web development, it not only demonstrates my technical expertise but also provides you an opportunity to inspect the source code via the provided GitHub link.',
    ],
    fullFeatureList: [
...

  {
    ...
    fullFeatureList: [
      ...
      'Contact form with Cloudinary image upload capabilities implemented with Nodemailer using Next.js server‐side methods, supported by Zod and Formik for robust field validation',
  ...
  },
  {
    ...
    projectType: 'Employed (Juniper Education)',
    description: [
      'Consilium Academy Trust is a bespoke website built to highlight their academies across the country. Designed with a clean, modern aesthetic, the site employs multiple load-in animations and subtle transitions to enhance user engagement. It is fully responsive and future-proofed to accommodate the addition of new schools as the trust expands.',
    ],
    fullFeatureList: [
...

  {
    ...
    projectType: 'Employed (Juniper Education)',
    description: [
      'A comprehensive academy homepage developed for Guru Nanak Sich Academy. The design is built to be clonable, allowing the creation of distinct pages for the school’s various phases – primary, secondary, and sixth form. Subtle hero and content animations provide a professional and clean look, while all content is managed via an in-house content management system.',
    ],
    fullFeatureList: [
